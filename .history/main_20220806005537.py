...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.cur_texture = 0
        self.scale = 1
        self.main_path = ":resources:images/animated_characters/female_adventurer/femaleAdventurer"
    ...
    def update_animation(self, delta_time: float = 1 / 60):
            ...
            if self.player_sprite.change_x < 0 and self.character_face_direction == 1:
                self.character_face_direction = 0
            elif self.player_sprite.change_x > 0 and self.character_face_direction == 0:
                self.character_face_direction = 1
    ...
    def setup(self):
        ...
        self.player_sprite = arcade.Sprite(":resources:images/animated_characters/female_person/"
                                           ...
                                           SPRITE_SCALING)
        Textture = arcade.Texture(":resources:images/animated_characters/female_adventurer/femaleAdventurer_walk1.png", )
        self.player_sprite.textures.append(Textture)
        # self.player_sprite.textures.append("femaleAdventurer_walk0.png")
        # self.player_sprite.textures.append("femaleAdventurer_walk4.png")
        # self.player_sprite.textures.append("femaleAdventurer_walk6.png")
        # self.player_sprite.textures.append("femaleAdventurer_walk2.png")
