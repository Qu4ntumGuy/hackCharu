...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for i in range(10):            
            ...
            wall = arcade.Sprite(":resources:images/tiles/sandMid.png", repeat_count_y=20 , image_x=i*GRID_PIXEL_SIZE , scale=SPRITE_SCALING)

            # wall.center_x =  i*GRID_PIXEL_SIZE  + rand
