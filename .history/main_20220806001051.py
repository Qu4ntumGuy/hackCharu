...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.idle_texture_pair = self.load_texture_pair(":resources:images/animated_characters/female_adventurer/femaleAdventurer_walk1.png")

        self.walk_textures = []
        for i in range(8):
            texture = self.load_texture_pair(":resources:images/animated_characters/female_adventurer/femaleAdventurer_walk1.png")
    ...
    def update_animation(self, delta_time: float = 1 / 60):
        ...
        direction = 0
        self.texture = self.walk_textures[frame][0]     
